export const stockDescriptions = [
    {
        ...
        description:'Потеря зуба – это не просто эстетическая проблема, но и риск для здоровья всей челюсти. Имплантация – это современный и надежный способ восстановить улыбку без ущерба для соседних зубов.'
    },
    {
        head:'АКЦИЯ: ПРОФЕССИОНАЛЬНАЯ ЧИСТКА ЗУБОВ ПО ВЫГОДНОЙ ЦЕНЕ',
        description:'Профессиональная чистка – это не только эстетика, но и профилактика кариеса, заболеваний десен и неприятного запаха. Эта процедура поможет сохранить ваши зубы здоровыми и красивыми на долгие годы..'
    },
    {
        head:'АКЦИЯ: ОТБЕЛИВАНИЕ ЗУБОВ',
        description:'Белоснежная улыбка — это уверенность и привлекательность. Мы заботимся о наших пациентах, поэтому предлагаем безопасное и эффективное отбеливание зубов с сохранением здоровья эмали. Осветление зубов на несколько тонов без боли и дискомфорта!'
    }
]
